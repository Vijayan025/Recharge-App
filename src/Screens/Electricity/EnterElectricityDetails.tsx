...
const EnterElectricityDetails = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    setTimeout(() => {
      setLoading(false);
      navigation.navigate(UserScreens.ebBillReview.routeName, {
        type: 'Tamil Nadu Electricity Board (TNEB)',
        number: datas,
      });
    }, 1500);
  };
...
export default EnterElectricityDetails;
