...
import TnebLogo from '../../../assets/images/indianOilLogo.png';
      ...
      {loading ? (
        ...
        <View>
            ...
            <View
              ...
              <Pressable
                onPress={() => {
                  ...
                  setTimeout(() => {
                    navigation.navigate(
                      UserScreens.gasPipelineBillReview.routeName,
                      {
                        type: 'Indian Oil Corporation Ltd (IOCL) - Piped Gas',
                        number: '041544545445',
                      },
                    );
                    setOnLoading(false);
                    ...
                    <View
                      ...
                      <View style={[Margins.mlMd, {width: '70%'}]}>
                        <Text
                          ...
                          Indian Oil Corporation Ltd (IOCL) - Piped Gas
                        </Text>
                        <Text
                          style={[
                            {
          ...
          <View style={[Paddings.paddingHorizontalMedium]}>
            ...
            <Pressable
              onPress={() =>
                navigation.navigate(UserScreens.gasPipelineDetails.routeName, {
                  type: 'Indian Oil Corporation Ltd (IOCL) - Piped Gas',
                })
              }>
              <View
...
export default BroadbandProviders;
